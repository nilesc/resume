...
\urlstyle{same}\url{www.linkedin.com/in/niles-christensen/} \\ % Your website, LinkedIn profile or other web address
...
\location{Grad. June 2014 | Menlo Park, CA}
...
\begin{tightitemize}
    \item Created automated systems in Go to probe Loon’s networks
    ...
    \item Improved a Reinforcement Learning model (details cannot be disclosed)
\end{tightitemize}
...
\location{Spring 2017 - Spring 2019 (5 Semesters) | New York, NY}
\begin{tightitemize}
